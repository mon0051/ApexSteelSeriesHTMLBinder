...
# Regular Keys
# Qwerty Numbers
Key.create({name: 'Escape', scancode: '12233', keygroup_id: kg[:top].id   , keycode1: kc[:k999], x_pos: 0*sf    , y_pos: 0*sf , keyblock_id: kb[:Esc].id})
Key.create({name: '~'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 0*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '1'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 10*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '2'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 20*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '3'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 30*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '4'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 40*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '5'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 50*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '6'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 60*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '7'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 70*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '8'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 80*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '9'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 90*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '0'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 100*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '-'     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 110*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name: '='     , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 120*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
Key.create({name:'BckSpc' , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 130*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyNo].id})
# Qwerty Line 1
Key.create({name:'Tab'  , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 0*sf    , y_pos: 0*sf   , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'Q'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 15*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'W'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 25*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'E'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 35*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'R'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 45*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'T'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 55*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'Y'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 65*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'U'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 75*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'I'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 85*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'O'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 95*sf    , y_pos: 0*sf  , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'P'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 105*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'['    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 115*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL1].id})
Key.create({name:']'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 125*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL1].id})
Key.create({name:'\\'   , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 135*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL1].id})
# Qwerty Line 1
Key.create({name:'Caps' , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 0*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'A'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 18*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'S'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 28*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'D'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 38*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'F'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 48*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'G'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 58*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'H'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 68*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'J'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 78*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'K'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 88*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'L'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 98*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:';'    , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 108*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'\''   , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 118*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
Key.create({name:'Rtn'  , scancode: '12233', keygroup_id: kg[:bottom].id, keycode1: kc[:k999], x_pos: 128*sf    , y_pos: 0*sf , keyblock_id: kb[:QwertyL2].id})
