...
$kb[:MediaKeys1] = Keyblock.create({name:'MediaKeys1'     ,x_offset: 255   * $sf, y_offset: 0    * $sf})
$kb[:MediaKeys2] = Keyblock.create({name:'MediaKeys2'     ,x_offset: 255   * $sf, y_offset: 22.5 * $sf})
